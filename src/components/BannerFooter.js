...
const BannerFooter = () => {
  ...
  return (
    <div className='bg-footer-background flex flex-col items-center pt-3' >
        <div className='flex flex-col w-[340px] text-footer-typo-color my-4 bg-cover bg-center overflow-hidden opacity-75 footer-background'>
